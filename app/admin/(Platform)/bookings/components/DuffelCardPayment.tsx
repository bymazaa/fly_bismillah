...
export default function DuffelCardPayment({
  ...
  const hasCardInfo =
    cardInfo &&
    (cardInfo.cardNumber || cardInfo.holderName || cardInfo.expiryDate);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-md shadow-gray-100/80">
